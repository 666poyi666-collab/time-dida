...
## v0.12.86 - 2026-08-11（UI 迭代实施中：桌面密度/断点与小窗打磨、移动连续工作面与 640/760 响应式、IME/系统主题/a11y 修复）
...
- **当前状态**：本条目如实记录为**实施中**——尚未构建、未打包、未安装任何设备、未创建 `release-v01286/`、未推送、未打 tag、未发布。OPPO OWW221 保持退役/冻结，不作为新版本门禁目标。0.12.85 的安装矩阵与历史 Bug 记录原样保留。
