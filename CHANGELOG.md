...
- private/public Worker 已更新并通过远端 19/19；Windows、华为平板和小米同版实装，真实配对后的任务、live 与账本三路闭环通过。ChatGPT Web 仍缓存旧只读插件，刷新与写权限 OAuth 等待用户确认；0.12.105 保持本地候选、未创建 GitHub Release。
