...
4. [releases/v0.10.0.md](releases/v0.10.0.md)：v0.10.0 的 Release 正文候选；只有门禁完成后才可复制到本地资产与 GitHub Release。
5. [../frontend-design/FRONTEND_SPEC.md](../frontend-design/FRONTEND_SPEC.md)：用户可见行为、主题、动效与小窗表现。
