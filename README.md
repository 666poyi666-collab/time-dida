...
| 0.12.22 | `release-v01222/FocusLink-0.12.22-x64.exe`（本机同步服务与队列恢复） | [v0.12.22](release-v01222/RELEASE_NOTES.md) |
...
- [v0.12.22 Release 正文](release-v01222/RELEASE_NOTES.md)
- [版本历史](CHANGELOG.md)
