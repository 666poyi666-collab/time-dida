...
| 版本 | 本地安装版 | 版本说明 |
| --- | --- | --- |
| 0.12.42 | `release-v01242/FocusLink-0.12.42-x64.exe`（三端自动配对与同版交付） | [v0.12.42](release-v01242/RELEASE_NOTES.md) |
| 0.12.29 | `release-v01229/FocusLink-0.12.29-x64.exe`（双机自动配对与系统计时表面验证） | [v0.12.29](release-v01229/RELEASE_NOTES.md) |
| 0.12.28 | 发布说明归档（系统计时表面、安全配对与任务层级） | [v0.12.28](release-v01228/RELEASE_NOTES.md) |
...
- [v0.12.42 Release 正文](release-v01242/RELEASE_NOTES.md)
- [版本历史](CHANGELOG.md)
