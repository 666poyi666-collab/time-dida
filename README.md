...
| 0.12.9 | `release-v0129/FocusLink-0.12.9-x64.exe`（待构建） | [v0.12.9](release-v0129/RELEASE_NOTES.md) |

每次版本迭代必须同步更新 `CHANGELOG.md`、本地 `RELEASE_NOTES.md` 和 GitHub Release，并上传安装版、便携版与 SHA256。只推送代码或 tag 不算发布完成。

v0.12.9 的本地发布状态以同目录 `RELEASE_NOTES.md` 为准，线上状态以 GitHub Releases 回读结果为准。v0.12.8 的公开 tag 在发布记录直接父子关系门禁被阻断，保持不移动。每个新版本都必须由 tag workflow 复验已提交产物，并回读正文、目标提交、附件名称、字节数、下载链接与下载后 SHA256。
...
- [当前版本 v0.12.9 Release 正文](release-v0129/RELEASE_NOTES.md)
