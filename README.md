...
> 当前候选版本：v0.12.87（桌面 token/radius 与移动粘性操作门禁已补强；全量构建、三设备同版实装和 GitHub `main` 推送进行中。OPPO 手表保持退役/冻结，不再开发或纳入门禁）
>
...
| 版本    | 本地安装版                                                     | 版本说明                                    |
| ------- | -------------------------------------------------------------- | ------------------------------------------- |
| 0.12.87 | 当前候选：0.12.86 后续 UI 合同补修触发新候选身份；全量门禁与实装进行中 | 待生成 |
...
- v0.12.87 版本说明将在最终干净提交完成打包后写入 `release-v01287/`。
