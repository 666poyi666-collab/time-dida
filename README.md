...
v0.11.3 的正式线上记录在完整门禁通过后发布到 [GitHub Releases](https://github.com/666poyi666-collab/time-dida/releases)。每个新版本都必须由 tag workflow 复验已提交产物，并回读正文、目标提交、附件名称、字节数、下载链接与下载后 SHA256；不能移动失败的旧 tag，也不能补造未完成门禁的历史 Release。
...
- [v0.11.3 Release 正文](FocusLink/backend-design/releases/v0.11.3.md)
