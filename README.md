...
每个版本构建后会生成两类产物（位于仓库根目录的 `release-vXXX/` 文件夹，当前版本为 `release-v023/`）：

| 类型 | 路径 | 说明 |
| --- | --- | --- |
| 安装包 | `release-v023/FocusLink-0.2.3-x64.exe` | NSIS 安装程序，双击即可安装，无需 PowerShell |
| 免安装版 | `release-v023/FocusLink-0.2.3-x64-portable.exe` | 单文件便携版，双击即可运行 |
