...
> 当前候选版本：v0.12.85（Windows、华为平板与小米手机已安装回读；OPPO 手表已退役，不再开发或纳入发布验证；完整最终树已干净整合并推送 GitHub main，提交 40d6dec；未创建 tag 或 GitHub Release——用户未要求正式发布）
>
...
| 版本    | 本地安装版                                                     | 版本说明                                    |
| ------- | -------------------------------------------------------------- | ------------------------------------------- |
| 0.12.85 | 三设备已安装回读；OPPO 已退役；已推送 main（40d6dec），未创建 tag/Release | [v0.12.85](release-v01285/RELEASE_NOTES.md) |
...
- [v0.12.85 版本说明](release-v01285/RELEASE_NOTES.md)（当前候选；已推送 GitHub main 提交 `40d6dec`；未创建 tag 或 GitHub Release）
