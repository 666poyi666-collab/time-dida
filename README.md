...
> 当前版本：v0.12.105
>
> 0.12.105 升级 Dashboard、字体、设置与同步状态，并让 FocusLink MCP / CLI 管理开始时间、截止时间、优先级、标签、父子任务和结构化循环；ChatGPT Web 通过 OAuth MCP 读取云端时间和任务，CLI 使用独立设备凭据。本轮完成三端同版实装前不标记为已发布；OPPO 手表保持退役/冻结。
>
