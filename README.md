...
> 当前版本：v0.12.19
>
> 版本主题：规整设置工作区 · 粒子消散时间之带 · 全量语义账本 · 256×70 小窗
...
| 版本 | 本地安装版 | 版本说明 |
| --- | --- | --- |
| 0.12.17 | `release-v01217/FocusLink-0.12.17-x64.exe`（安装器修正版） | [v0.12.17](release-v01217/RELEASE_NOTES.md) |
| 0.12.18 | `release-v01218/FocusLink-0.12.18-x64.exe`（跨账户误判修复） | [v0.12.18](release-v01218/RELEASE_NOTES.md) |
| 0.12.19 | `release-v01219/FocusLink-0.12.19-x64.exe`（界面与消散动效重构） | [v0.12.19](release-v01219/RELEASE_NOTES.md) |
...
- [历史发布档案](FocusLink/backend-design/releases/README.md)

### 当前发布

- [v0.12.19 Release 正文](release-v01219/RELEASE_NOTES.md)
- [版本历史](CHANGELOG.md)
