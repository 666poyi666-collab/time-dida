...
> 当前候选版本：v0.12.86（UI 迭代实施中：桌面密度/断点与小窗打磨，移动连续工作面与 640 粘性操作/760 双栏细化，IME/系统主题/a11y 修复；未构建、未安装、未发布。OPPO 手表保持退役/冻结，不再开发或纳入门禁）
>
...
| 版本    | 本地安装版                                                     | 版本说明                                    |
| ------- | -------------------------------------------------------------- | ------------------------------------------- |
| 0.12.86 | 实施中：UI 迭代，未构建/未安装/未发布；不创建 release 目录     | v0.12.86 |
...
- v0.12.86（UI 迭代实施中；未构建、未安装、未发布，不创建 tag 或 GitHub Release）
