...
> 当前版本：v0.12.20
>
> 版本主题：采样式粒子消散 · 时间切片逐秒瓦解 · 256×70 小窗同步动效
...
| 0.12.20 | `release-v01220/FocusLink-0.12.20-x64.exe`（采样式时间切片消散） | [v0.12.20](release-v01220/RELEASE_NOTES.md) |
...
- [v0.12.20 Release 正文](release-v01220/RELEASE_NOTES.md)
- [版本历史](CHANGELOG.md)
