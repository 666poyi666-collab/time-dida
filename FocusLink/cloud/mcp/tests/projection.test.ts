...
function ledger(id: string, changeSeq: number, activeElapsedMs: number): FeedEntityRow {
...
function metadata(id: string, changeSeq: number, taskId: string, taskTitle: string): FeedEntityRow {
