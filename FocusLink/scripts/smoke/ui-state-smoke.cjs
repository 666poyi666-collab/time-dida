...
async function main() {
  ...
  const assertions = [
    ...
    [results.idle.primaryBackground.includes('76, 88, 208'), 'idle primary uses brand accent'],
    [results.paused.primaryBackground.includes('76, 88, 208'), 'resume uses brand accent'],
    [results.running.successToken === '12 138 91', 'focus green token'],
    [results.paused.pauseToken === '224 49 60', 'pause red token'],
