...
- **候选身份**：0.12.102 已实际安装 Windows/华为，交互行为变化提升为 0.12.103/1303。最终 Windows 安装包身份为 `0.12.103 / af5ca29`，华为已 `adb install -r` 回读 `0.12.103/1303` 并通过 WebView 功能回读；小米仍因 ADB `offline` 未安装。
