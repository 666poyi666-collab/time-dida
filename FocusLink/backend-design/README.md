...
> 适用版本：v0.11.x 设计基线（当前实现 v0.11.2）
>
...
4. [releases/v0.11.2.md](releases/v0.11.2.md)：v0.11.2 的当前 Release 正文源；内容必须与本地发布目录和 GitHub Release 一致。
5. [releases/v0.11.1.md](releases/v0.11.1.md)：被发布 workflow 最终清理错误阻断后的离线发布记录；公开 tag 不移动，未创建 GitHub Release。
6. [releases/v0.11.0.md](releases/v0.11.0.md)：更早的离线发布记录。
