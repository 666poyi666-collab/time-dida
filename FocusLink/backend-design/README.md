...
> 适用版本：v0.11.x 设计基线（当前实现 v0.11.5）
>
...
4. [releases/v0.11.4.md](releases/v0.11.4.md)：最近正式版 v0.11.4 的 Release 正文源；内容必须与本地发布目录和 GitHub Release 一致。v0.11.5 在正式构建与验收完成前不提前生成带占位符的发布正文。
