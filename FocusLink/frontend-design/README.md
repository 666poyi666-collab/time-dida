...
> 适用版本：v0.12.x 系列；当前对应 v0.12.86「UI 迭代实施中：桌面密度/断点与小窗打磨，移动连续工作面与 640/760 响应式，IME/系统主题/a11y 修复」
>
...
- [USER_REQUIREMENTS.md](USER_REQUIREMENTS.md)：长期维护的用户需求摘要、三端验收标准、状态与关联改动。
